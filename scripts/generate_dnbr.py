#!/usr/bin/env python3
"""
Main dNBR generation script for GitHub Actions.
This script generates dNBR analyses using the specified method.
"""

import sys
import geopandas as gpd
from generate_dnbr_utils import load_aoi
import sys
import os
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("Note: Use 'python generate_leaflet.py <aoi_path>' to generate maps separately")
        sys.exit(1)
