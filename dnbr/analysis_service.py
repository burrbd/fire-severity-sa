...
class AnalysisService:
    ...
    def _to_dynamodb_item(self, analysis: DNBRAnalysis) -> dict:
        ...
        item = {
            ...
            'raw_raster_url': {'S': analysis.raw_raster_url or ''},
            'source_vector_url': {'S': analysis.source_vector_url or ''},
    ...
    def _from_dynamodb_item(self, item: dict) -> DNBRAnalysis:
        ...
        json_data = {
            ...
            'raw_raster_url': item.get('raw_raster_url', {}).get('S'),
            'source_vector_url': item.get('source_vector_url', {}).get('S'),
